...
const Services = () => {
    return (
        <>
            ...
            <div className='section-padding termscontent'>
                <div className='container'>
                    <p>Our Terms of Service were last updated on [___DATE___].</p>
                    <p>Please read these terms and conditions carefully before using Our Service.</p>
                    <h2 className='mt-3'>Interpretation and Definitions</h2>
                    <h4 className='mt-2'>Interpretation</h4>
                    <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                    <h4 className='mt-2'>Definitions</h4>
                    ...
                    <h4 className='mt-2'>Acknowledgment</h4>
                    ...
                    <h4 className='mt-2'>User Accounts</h4>
                    ...
                    <h4 className='mt-2'>Your Right to Post Content</h4>
                    ...
                    <h4 className='mt-2'>Content Restrictions</h4>
                    ...
                    <h4 className='mt-2'>Content Backups</h4>
                    ...
                    <h2 className='mt-3'>Copyright Policy</h2>
                    <h4 className='mt-2'>Intellectual Property Infringement</h4>
                    ...
                    <h4 className='mt-2'>DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h4>
                    ...
                    <h4 className='mt-2'>Intellectual Property</h4>
                    ...
                    <h4 className='mt-2'>Your Feedback to Us</h4>
                    ...
                    <h4 className='mt-2'>Links to Other Websites</h4>
                    ...
                    <h4 className='mt-2'>Termination</h4>
                    ...
                    <h4 className='mt-2'>Limitation of Liability</h4>
                    ...
                    <h4 className='mt-2'>{'\"'}AS IS{'\"'} and {'\"'}AS AVAILABLE{'\"'} Disclaimer</h4>
                    ...
                    <h4 className='mt-2'>Governing Law</h4>
                    <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>
                    <h4 className='mt-2'>Disputes Resolution</h4>
                    <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
                    <h4 className='mt-2'>For European Union (EU) Users</h4>
                    <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.</p>
                    <h4 className='mt-2'>United States Legal Compliance</h4>
                    <p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a {'\"'}terrorist supporting{'\"'} country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>
                    <h2 className='mt-3'>Severability and Waiver</h2>
                    <h4 className='mt-2'>Severability</h4>
                    <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>
                    <h4 className='mt-2'>Waiver</h4>
                    ...
                    <h4 className='mt-2'>Translation Interpretation</h4>
                    ...
                    <h4 className='mt-2'>Changes to These Terms of Service</h4>
